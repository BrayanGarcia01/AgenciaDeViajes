...
public class PaqueteWeb {
     ...
     * @param fotos 
     */
    public PaqueteWeb(int idPaquete, String tipoPaquete, String nombrepaquete, int precio, String fechaInicio, String fechaFin, String ciudades, String vuelos, String hoteles, String habitaciones, String cityTuours, String alimentaciones,VString[] fotos) {
    ...
    public VString[] getFotos() {
        return fotos;
    }

    public void setFotos(VString[] fotos) {
        this.fotos = fotos;
    }
